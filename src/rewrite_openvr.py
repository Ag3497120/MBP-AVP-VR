...
class MyVRSystem : public FakeIVRSystem {
public:
...
class MyVRCompositor : public FakeIVRCompositor {
public:
...
class MyVRSettings : public FakeIVRSettings {
public:
    virtual const char *GetString(const char *pchSection, const char *pchSettingsKey, EVRSettingsError *peError = 0L) override {
...
class MyVRInput : public FakeIVRInput {
public:
...
class MyVRRenderModels : public FakeIVRRenderModels {
public:
...
FakeIVRApplications g_IVRApplications;
FakeIVRChaperone g_IVRChaperone;
FakeIVRChaperoneSetup g_IVRChaperoneSetup;
FakeIVROverlay g_IVROverlay;
...
print("Rewritten openvr_emulator.cpp")
