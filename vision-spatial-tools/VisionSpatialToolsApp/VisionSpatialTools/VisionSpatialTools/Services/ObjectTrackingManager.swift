...
class AdaptiveToolFollower: ObservableObject {
    ...
    @Published var followingTools: [UInt64: FollowingTool] = [:]
    ...
    private func updateFollowingTool(toolId: UInt64) async {
    ...
    private func updateToolSize(_ tool: FollowingTool, trackingInfo: TrackedObjectInfo) {
        ...
        case .browser, .vrScreen:
            // Default scale for browser and VR screen
            scale = 1.0
        }
